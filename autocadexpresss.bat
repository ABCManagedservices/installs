...
echo Chocolatey is ready to begin installing packages! WOOOOOOHOOOOOOO!
pause




:: ####----[ Whatever you want to install, place it below this point, each item on its own line (to make it easier to find later on. ] ----
::
choco install autocad microsoft-teams adobereader zoom
:: ########---[You can add as many programs here as you desire!]----#########
echo Y
pause
echo.
echo Your installation is complete enjoy! 
pause
echo EXIT
